...
const Formulario = ({
  ...
  const crearNuevaReservacion = () => {
    ...
    const cita = { Cliente, Propietario , telefono, fecha, hora, Cantidad };
  ...
  return (
    <>
      <ScrollView style={styles.formulario}>
        ...
        <View>
          <Text style={styles.label}>no fumadores/fumadores:</Text>
          <TextInput
            style={styles.input}
        ...
        <View>
          ...
          >
            <Text style={styles.textoSubmit}>CrearReservacion</Text>
          </TouchableHighlight>
        </View>
      </ScrollView>
    </>
